...
//Code Here
for(let i = 0; i < lastItemRemoved.length; i ++){
...
//Code Here
switch(letterGrade){
  case "A": console.log("The student is doing well.")
  case "B": console.log("Doing well")
  case "C": console.log("alright")
  case "D": console.log("not well")
  case "E": console.log("failing")
  default: console.log("not a grade")
}
